...
speakers = [
    [
        "Npc_Zelda_Opening",
        "Dm_Npc_Zelda_AncientHyrule",
        "Dm_Npc_Zelda_Search_Improve",
        "Dm_Npc_Zelda_Catch",
    ],
...
imgsRoot = r"D:\game\dump_totk_files\000-workplace\collect_voice\concact"

# 解压分类好的文件后，能够看到各自语音的文件夹。
spksRoot = r"D:\game\dump_totk_files\000-workplace\collect_voice\output"

# soundMapSpeaker... json文件的路径
textMapPath = r"D:\game\dump_totk_files\000-workplace\collect_voice\textMap.json"

# 生成的视频，字幕等的输出路径
outPutFolderRoot = r"D:\game\dump_totk_files\000-workplace\collect_voice\concact"
